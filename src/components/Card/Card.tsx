...
export const Card =  (props:AppProps) =>  {
        ...
        <div>
                <div className="bg-primary rounded rounded-t-lg overflow-hidden shadow w-full my-3">
                        <LazyLoadImage effect="blur" src={image} className="w-full h-32 object-cover" alt="card_header"/>
                        <div className="grid grid-cols-3 gap-2 px-5">
                                <div className="flex -mt-8 justify-center">
                                        <LazyLoadImage effect="blur" src={profile_pic} className="w-28 h-28 object-cover rounded-full border-solid border-secondary border-2 -mt-3"  alt="profile_picture"/>		
                                </div>
                                <div className="col-span-2 pb-6 pt-2">
                                        <div className="flex justify-between">
                                        <h4 className="text-primary text-lg font-bold font-sans">{name}</h4>
